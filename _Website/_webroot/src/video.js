...
function onPlayerStateChange(evt) {
    switch (_.get(evt, 'data')) {
        case YT.PlayerState.PLAYING : {
            trace('onPlayerStateChange; PLAYING');
            break;
        }
        ...
        default : {
            trace('onPlayerStateChange; no handler for event: ' + _.findKey(YT.PlayerState, function(o) { return o === _.get(evt, 'data'); }));
            break;
        }
    }
