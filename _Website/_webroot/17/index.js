...
var cLaunchDateModern = Date.parse(Date.now().getFullYear().toString() + "-12-07 0:33 -500");
var cCountdownStartDate = Date.parse("1972-12-06 9:55:39pm -500");
var cCountdownStartDateModern = Date.parse(Date.now().getFullYear().toString() + "-12-06 9:55:39pm -500");
